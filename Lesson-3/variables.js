...
*console.log(variable1); konsolda, variable1 değişkeni içine depolanmış olan datayı çıkartır.
    ...
    **Bu günki dersimiz değişkenler. Değişken ifadesinin ne olduğunu zaten biliyorum C dilinden fakat JS dilinde biraz farklılıkları var. C de atayacağımız değişken türleri vardır. Değişkenin içinde depolanacak olan dataya göre farklı farklı değişken türleri vardır. Fakat burada değişken türleri bulunmamaktadır yazdığımız datanın türü fark etmeksizin depolayacaktır. Hadi jsteki değişkenlerin syntaxını inceleyelim.
